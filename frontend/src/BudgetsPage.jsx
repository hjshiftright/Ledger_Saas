      ...
      {budgets.filter(b => b.is_active).length > 0 && (
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white rounded-xl border border-slate-100 p-3 text-center shadow-sm">
            <div className="text-xl font-bold text-[#2C4A70]">{budgets.filter(b => b.is_active).length}</div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    type="button"
                    onClick={addItem}
                    className="text-xs text-[#2C4A70] hover:text-[#1F344F] font-medium flex items-center gap-1"
                  >
                ...
                <div className="space-y-2">
                  {formItems.map((item, i) => (
                    <div key={i} className="flex gap-2 items-center">
                      <select
                        className="flex-1 border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#2C4A70]/30 focus:outline-none"
                      ...
                      <input
                        type="number"
                        placeholder="Amount ₹"
                        className="w-32 border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#2C4A70]/30 focus:outline-none"
